...
<script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
 ...
 <div id="about" class="container-fluid about py-5">
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-7" style="background: linear-gradient(rgba(255, 255, 255, .8), rgba(255, 255, 255, .8)), url(img/about-img-1.png);">
                        ...
                        <p class="mb-4">
                            Discover the enchanting beauty of Wayanad, where lush green landscapes meet mist-covered hills and serene waterfalls. Nestled in the heart of Kerala, Wayanad offers a perfect blend of adventure, culture, and relaxation. From exploring ancient caves and wildlife sanctuaries to savoring the local cuisine and rejuvenating amidst nature, Wayanad is a paradise waiting to be explored. Plan your escape today and immerse yourself in the magic of this unspoiled gem!</p>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                                    ...
                                    <div class="service-icon p-4">
                                        <i class="fa fa-user fa-4x " style="color: #137b18"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                                    ...
                                    <div class="service-icon p-4">
                                        <i class="fa fa-cog fa-4x " style="color: #137b18"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <ul class="nav nav-pills d-inline-flex justify-content-center mb-5">
                        ...
                        <li class="nav-item">
                            <a class="d-flex py-2 mx-3 border border-primary bg-light rounded-pill" data-bs-toggle="pill" href="#tab-2">
                                <span class="text-dark" style="width: 150px;">Edakkal Caves</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="d-flex mx-3 py-2 border border-primary bg-light rounded-pill" data-bs-toggle="pill" href="#tab-3">
                                <span class="text-dark" style="width: 150px;">Chembra Peak</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="d-flex mx-3 py-2 border border-primary bg-light rounded-pill" data-bs-toggle="pill" href="#tab-4">
                                <span class="text-dark" style="width: 150px;">Wildlife Sanctuary</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="d-flex mx-3 py-2 border border-primary bg-light rounded-pill" data-bs-toggle="pill" href="#tab-5">
                                <span class="text-dark" style="width: 150px;">Pookode Lake</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="d-flex mx-3 py-2 border border-primary bg-light rounded-pill" data-bs-toggle="pill" href="#tab-6">
                                <span class="text-dark" style="width: 150px;">Kuruvadweep</span>
                            </a>
                        </li>
                    </ul>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="destination-img">
                                                ...
                                                <div class="destination-overlay p-4">
                                                    ...
                                                    <h4 class="text-white mb-2 mt-3">Chembra Peak</h4>
        ...
        <div class="container-fluid ExploreTour py-5">
            <div class="container py-5">
                <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                    <h5 class="section-title px-3">WAYANAD</h5>
        ...
        <!-- Packages Start -->
        <div id="package" class="container-fluid packages py-5">
            <div class="container py-5">
                <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                ...
                @foreach ($restaurants as $restaurant)
                    <div class="packages-item">
                        <div class="packages-img">
                            @if ($restaurant->image)  <!-- Check if the restaurant has an image -->
                                <img src="{{ asset('storage/' . $restaurant->image) }}" class="img-fluid w-100 rounded-top" alt="{{ $restaurant->title }} Image" style="height: 300px; object-fit: cover;">
                            @else
                                <img src="{{ asset('images/placeholder.jpg') }}" class="img-fluid w-100 rounded-top" alt="Placeholder Image" style="height: 300px; object-fit: cover;">
                            @endif
                            <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute" style="width: 100%; bottom: 0; left: 0; z-index: 5;">
                                <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt me-2"></i>{{ $restaurant->location }}</small>
                                <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt me-2"></i>{{ $restaurant->duration }} days</small>
                                <small class="flex-fill text-center py-2"><i class="fa fa-user me-2"></i>{{ $restaurant->persons }} Person</small>
                            </div>
                            <!-- <div class="packages-price py-2 px-4">{{ $restaurant->price }}</div> -->
                        </div>
                        <div class="packages-content bg-light">
                            <div class="p-4 pb-0">
                                <h5 class="mb-0">{{ $restaurant->title }}</h5>
                                <small class="text-uppercase">Restaurant Deals</small>
                                <div class="mb-3">
                            ...
                            <div class="row bg-primary rounded-bottom mx-0">
                                <div class="col-6 text-start px-0">
                                    <a href="{{ $restaurant->url }}" class="btn-hover btn text-white py-2 px-4">Read More</a>
                                </div>
                                <div class="col-6 text-end px-0">
                                    <a href="{{ $restaurant->url }}" class="btn-hover btn text-white py-2 px-4">Book Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-fluid gallery py-5 my-5">
            <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                ...
                <p class="mb-0">Wayanad, a serene haven of lush greenery, waterfalls, wildlife, and rich culture, invites you to unforgettable adventures.
                </p>
            </div>
            <div class="tab-class text-center">
                <ul class="nav nav-pills d-inline-flex justify-content-center mb-5">
    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                ...
                <p class="text-white mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur maxime ullam esse fuga blanditiis accusantium pariatur quis sapiente, veniam doloribus praesentium? Repudiandae iste voluptatem fugiat doloribus quasi quo iure officia.</p>
                <p class="text-white mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur maxime ullam esse fuga blanditiis accusantium pariatur quis sapiente, veniam doloribus praesentium? Repudiandae iste voluptatem fugiat doloribus quasi quo iure officia.</p>
            ...
            <div class="col-lg-6">
                ...
                <form action="{{ route('bookings.store') }}#booking" method="POST">
                            @csrf
                            <div class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select class="form-select bg-white border-0" id="CategoriesSelect" name="categories" required>
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control bg-white border-0" placeholder="Special Request" id="message" name="request" style="height: 100px" required></textarea>
        ...
        <!-- Blog Start -->
        <div id="resorts" class="container-fluid blog py-5">
    <div class="container py-5">
        <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                    ...
                    <div class="blog-item">
                        <div class="blog-img">
                            <div class="blog-img-inner">
                                <!-- Display the image from the resorts table -->
                                <img class="img-fluid w-100 rounded-top" src="{{ asset('storage/' . $resort->image) }}" alt="Image" style="height: 300px; object-fit: cover;">
                                <div class="blog-icon">
                                    <a href="#" class="my-auto"><i class="fas fa-link fa-2x text-white"></i></a>
                                </div>
                            </div>
                            <div class="blog-info d-flex align-items-center border border-start-0 border-end-0">
                                <small class="flex-fill text-center border-end py-2">
                                    <i class="fa fa-calendar-alt text-primary me-2"></i>{{ $resort->created_at->format('d M Y') }}
                                </small>
                                <a href="#" class="btn-hover flex-fill text-center text-white border-end py-2">
                                    <i class="fa fa-thumbs-up text-primary me-2"></i>{{ $resort->likes_count }}
                                </a>
                                <a href="#" class="btn-hover flex-fill text-center text-white py-2">
                                    <i class="fa fa-comments text-primary me-2"></i>{{ $resort->comments_count }}
                                </a>
                            </div>
                        </div>
                        <div class="blog-content border border-top-0 rounded-bottom p-4">
                            <p class="mb-3">Posted By: {{ $resort->author_name }}</p>
                            <a href="#" class="h4">{{ $resort->title }}</a>
                            <p class="my-3">{{ Str::limit($resort->body, 100) }}</p> <!-- Display a truncated version of the body -->
                            <a href="{{ $resort->url }}" class="btn btn-primary rounded-pill py-2 px-4">Read More</a>
                        </div>
                    </div>
                </div>
            @endforeach
                ...
                <div class="testimonial-carousel owl-carousel">
                    <div class="testimonial-item text-center rounded pb-4">
                        ...
                        <div style="margin-top: -35px;">
                            <h5 class="mb-0">Place</h5>
                            <p class="mb-0">Meppadi</p>
